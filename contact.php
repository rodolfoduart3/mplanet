  ...
  <body class="contact-page">
    ...
    <section class="container">
      <div class="row formContact">
        <h1 class="title-section" id="contact_title">Formulário de Contato</h1>
        <form id="form_contact" method="post" action="libs/sendForm.php" class="col s12">
          <div class="row">
            <div class="input-field col s12 m6">
              <input type="text" name="name" required />
              <label for="name" id="name_contact">Nome</label>
            </div>
            <div class="input-field col s12 m6">
              <input type="email" name="email" required />
              <label for="email" id="email_contact">E-mail</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12">
              <textarea name="message" class="materialize-textarea" required></textarea>
              <label for="message" id="message_contact">Digite sua mensagem...</label>            
            </div>
          </div>
          <div class="row boxBtn">
            <button type="submit" name="button" class="btn" id="btn_contact">Enviar</button>
          </div>
        </form>
